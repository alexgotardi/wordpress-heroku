...
/* ====================================================================================================================================================== */
	...
	{
		// Register style
		wp_register_style( 'lora', 'http://fonts.googleapis.com/css?family=Lora:400,700,400italic,700italic' );
		wp_register_style( 'unifrakturmaguntia', 'http://fonts.googleapis.com/css?family=UnifrakturMaguntia' );
		wp_register_style( 'coustard', 'http://fonts.googleapis.com/css?family=Coustard' );
		...
		wp_register_style( 'google-code-prettify', get_template_directory_uri() . '/js/google-code-prettify/prettify.css' );
		wp_register_style( 'uniform', get_template_directory_uri() . '/css/uniform.default.css' );
		wp_register_style( 'flexslider', get_template_directory_uri() . '/css/flexslider.css' );
		wp_register_style( 'mediaelementplayer', get_template_directory_uri() . '/js/mediaelement/mediaelementplayer.css' );
		wp_register_style( 'gamma-gallery', get_template_directory_uri() . '/css/gamma-gallery.css' );
...
/* ====================================================================================================================================================== */
	...
	function my_save_meta_box_hide_post_title( $post_id )
	{
		...
		if ( ! wp_verify_nonce( isset( $_POST['my_meta_box_hide_post_title_nonce'] ), basename(__FILE__) ) )
		{
			return $post_id;
		}
...
/* ====================================================================================================================================================== */
	...
	function my_save_meta_box_gallery( $post_id )
	{
		...
		if ( ! wp_verify_nonce( isset( $_POST['nonce_gallery'] ), basename(__FILE__) ) )
		{
			return $post_id;
		}
...
/* ====================================================================================================================================================== */
	...
	function slide( $atts, $content = "" )
	{
		...
		$slide = '<li><img alt="' . $alt . '" src="' . $src . '">' . $content_out . '</li>';
...
/* ====================================================================================================================================================== */
	...
	function social_icon( $atts, $content = "" )
	{
		...
		elseif ( $type == 'google' ) { $type_icon = '&#107;'; }
...
/* ====================================================================================================================================================== */
	...
	function my_enqueue_login()
	{
		// Enqueue script
		wp_enqueue_script( 'jquery' );
	}
	// end my_enqueue_login
	
	add_action( 'login_enqueue_scripts', 'my_enqueue_login' );
...
/* ====================================================================================================================================================== */
	...
	function my_customize_register( $wp_customize )
	{
		...
		$wp_customize->add_setting( 'setting_link_color', array(	'default' => '#ce6607',
																	'transport' => 'refresh' ) );
		...
		$wp_customize->add_setting( 'setting_link_hover_color', array(	'default' => '#a35208',
																		'transport' => 'refresh' ) );
		...
		$wp_customize->add_setting( 'setting_menu_active_color', array(	'default' => '#cc3300',
																		'transport' => 'refresh' ) );
		...
		$wp_customize->add_setting( 'setting_text_logo_font', array(	'default' => 'UnifrakturMaguntia',
																		'transport' => 'refresh' ) );
		...
		$wp_customize->add_setting( 'setting_heading_font', array(	'default' => 'Coustard',
																	'transport' => 'refresh' ) );
		...
		$wp_customize->add_setting( 'setting_menu_font', array(	'default' => 'Coustard',
																'transport' => 'refresh' ) );
		...
		$wp_customize->add_setting( 'setting_content_font', array(	'default' => 'Lora',
																	'transport' => 'refresh' ) );
	...
	{
		?>
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo get_theme_mod( 'setting_text_logo_font', 'UnifrakturMaguntia' ); ?>">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo get_theme_mod( 'setting_heading_font', 'Coustard' ); ?>">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo get_theme_mod( 'setting_menu_font', 'Coustard' ); ?>">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo get_theme_mod( 'setting_content_font', 'Lora' ); ?>">
<style type="text/css">
a { color: <?php echo get_theme_mod( 'setting_link_color', '#ce6607' ); ?>; }
a:hover { color: <?php echo get_theme_mod( 'setting_link_hover_color', '#a35208' ); ?>; }
.main-navigation ul .current_page_item > a { color: <?php echo get_theme_mod( 'setting_menu_active_color', '#cc3300' ); ?>; }
h1.site-title, h1.site-title a { font-family: "<?php echo get_theme_mod( 'setting_text_logo_font', 'UnifrakturMaguntia' ); ?>", Georgia, serif; }
h1, h2, h3, h4, h5, h6 { font-family: "<?php echo get_theme_mod( 'setting_heading_font', 'Coustard' ); ?>", Georgia, serif; }
.main-navigation ul li { font-family: "<?php echo get_theme_mod( 'setting_menu_font', 'Coustard' ); ?>", Georgia, serif; }
html { font-family: "<?php echo get_theme_mod( 'setting_content_font', 'Lora' ); ?>", Georgia, serif; }
</style>
		<?php
	}
